...
VERS3=`ls -1t ${SQUID_WWW_PATH}/content/Versions/v3/ | grep -v "CVS|sig.dyn"`
for v in ${VERS3} "$@" ; do
#	echo "FOUND: $v"
	if test -d ${SQUID_WWW_PATH}/content/Versions/v3/${v}/cfgman ; then
#	echo "SCAN: ${v}/cfgman"
	for directive in ${SQUID_WWW_PATH}/content/Versions/v3/${v}/cfgman/*.html; do
